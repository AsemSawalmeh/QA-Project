...
public class CurrencyConverterControllerMockTest {
    ...
    private ArrayList<ConversionRates> mockedRates;
    ...
    public void setUp() {
        ...
        mockedRates.add(new ConversionRates("USD", 1.0, 1.0));
        mockedRates.add(new ConversionRates("EUR", 0.9124101365942007, 1.0959983453633586));
        mockedRates.add(new ConversionRates("INR", 82.82348573780213, 0.012073870003077906));
